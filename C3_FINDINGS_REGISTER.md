...
in 32 new rows:**
1. **C3L-90, happening right now.** The signup form is being farmed by bots. 181
   accounts, exactly **1** has ever followed a card, and roughly **180
   unsolicited emails** have gone out from C3's own sending domain in eight days.
   C3L-46's throttle is per address and cannot stop it.
