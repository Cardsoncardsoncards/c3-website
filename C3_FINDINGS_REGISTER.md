...
## 3. Confirmed findings, live investigation (IDs C3L-01 to C3L-42)
...
- **Live-investigation findings (C3L-):** 42 total. 16 resolved with evidence
  ...
  **C3L-40 stays High but is much narrower than it was**: Task 04 measured it
  at 8 ingestion-suspect cards and 45 unclear out of 242, with the other 189
  confirmed as genuine Marvel new-set price collapse, so the $0.07
  Ornithopter case is real but close to unique rather than typical.
  15 medium and still open (C3L-09, C3L-17 to C3L-24, C3L-33, C3L-34,
  C3L-35, C3L-38, C3L-41, C3L-42). **C3L-34 was downgraded from High to
  Medium on 5 August** after Task 03's investigation showed its central claim
  was wrong, see its corrected entry. 3 informational and positive (C3L-06,
  C3L-13, C3L-14).
...
- **Total rows this file currently tracks:** 83, across 4 ID ranges, out of
...
3. ~~**C3L-15 and C3L-16, both on the MTG card page.**~~ **Done, 5 August
   ...
   **What actually replaces it as the urgent item is C3L-39, and then a much
   ...
   the larger of the two. C3L-39 is 532 cards carrying a buy or sell
