...
- **Live-investigation findings (C3L-):** 54 total. 40 resolved with evidence
  ...
  **C3L-10 moved to resolved on 5 August, and how it got there is worth
  ...
  3 partly resolved (**C3L-52**, where `written_at` is closed for all 32
  games and `source` remains unpopulated for 31 of them; **C3L-49**, 26 of 31
  sync functions fixed on verified evidence and 5 deliberately left alone
  because the fix would have moved live URLs; **C3L-53**, the dishonest green
  removed but the three underlying schema mismatches not fixed).
  5 high and still fully open (C3L-03, C3L-11, C3L-32, C3L-40, **C3L-51**), of
