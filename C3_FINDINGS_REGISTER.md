...
## 3. Confirmed findings, live investigation (IDs C3L-01 to C3L-57)
...
- **Live-investigation findings (C3L-):** 57 total. 43 resolved with evidence
  ...
  **C3L-48**, **C3L-50**, **C3L-49**, **C3L-55**, **C3L-51**). **C3L-06 remains the significant one: the live
  ...
  **C3L-40 stays High but only its unresolved tail remains**: Task 04
  ...
  Tally: 43 resolved + 2 partly resolved + 4 high open (C3L-03, C3L-11,
  C3L-32, C3L-40) + 5 medium open (C3L-24, C3L-33, C3L-34, C3L-54, C3L-57)
  + 1 low open (C3L-56) + 2 informational = 57.
