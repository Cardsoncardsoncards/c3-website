...
## 3. Confirmed findings, live investigation (IDs C3L-01 to C3L-47)
...
- **Live-investigation findings (C3L-):** 47 total. 32 resolved with evidence
  ...
  C3L-44, C3L-45, **C3L-46**). **C3L-06 remains the significant one: the live
  ...
  6 high and still open (C3L-03, C3L-10, C3L-11, C3L-26, C3L-32, C3L-40), of
  ...
  **C3L-40 stays High but only its unresolved tail remains**: Task 04
  ...
  7 medium and still open (C3L-09, C3L-24, C3L-33, C3L-34, C3L-35, C3L-38,
  **C3L-47**). **C3L-34 was downgraded from High to Medium on 5 August**
  after Task 03's investigation showed its central claim was wrong.
  **C3L-47 is the newest and the only live security finding still open**, the
  password-reset endpoint's timing enumeration. 2 informational and positive
  (C3L-13, C3L-14). Tally: 32 + 6 + 7 + 2 = 47.
