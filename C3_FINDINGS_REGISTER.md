...
## 3. Confirmed findings, live investigation (IDs C3L-01 to C3L-52)
...
- **Live-investigation findings (C3L-):** 52 total. 40 resolved with evidence
  ...
  **C3L-48**, **C3L-50**). **C3L-06 remains the significant one: the live
  ...
  **C3L-10 moved to resolved on 5 August, and how it got there is worth
  ...
  1 partly resolved (**C3L-52**), where `written_at` is closed for all 32
  games and `source` remains unpopulated for 31 of them.
  6 high and still open (C3L-03, C3L-11, C3L-32, C3L-40, **C3L-49**,
  **C3L-51**), of
  which C3L-11 is permanently unfixable rather than merely outstanding.
  **C3L-49 and C3L-51 both came out of Task 10 and both were deliberately
  left open rather than half-done: C3L-49 because sweeping 30 working syncs
  can change live URLs and needs per-game verification first, C3L-51 because
  it needs a decision about where an alert should actually go.**
  **C3L-40 stays High but only its unresolved tail remains**: Task 04
  ...
  Tally: 40 resolved + 1 partly resolved + 6 high open + 3 medium open
  + 2 informational = 52.
...
- **Corrections to this file's own findings: 3.** Tracked deliberately,
  ...
  The common thread in all three is a finding written from one level of
  observation (one function, one card, whole-game cadence) and generalised to
  another without measuring at that second level.
