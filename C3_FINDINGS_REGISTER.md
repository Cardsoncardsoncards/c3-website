...
## 3. Confirmed findings, live investigation (IDs C3L-01 to C3L-37)
...
- **Live-investigation findings (C3L-):** 37 total. 16 resolved with evidence
  (C3L-01, C3L-02, C3L-04, C3L-05, C3L-07, C3L-08, C3L-12, C3L-15, C3L-16,
  C3L-25, C3L-27, C3L-28, C3L-29, C3L-30, C3L-31, C3L-37). 7 high and still open
  (C3L-03, C3L-10, C3L-11, C3L-26, C3L-32, C3L-34, C3L-36), of which C3L-11
  is permanently unfixable rather than merely outstanding, and **C3L-34 is a
  live mislabelled statistic on every MTG card page right now**, presenting a
  92 day extreme as a 52 week one. 11 medium and still open (C3L-09,
  C3L-17 to C3L-24, C3L-33, C3L-35). 3 informational and positive (C3L-06,
  C3L-13, C3L-14).
...
- **Total rows this file currently tracks:** 78, across 4 ID ranges, out of
...
3. ~~**C3L-15 and C3L-16, both on the MTG card page.**~~ **Done, 5 August
   ...
   **What replaces it as the urgent item is C3L-34.** The card page's
   "52 week high/low", and the buy and sell verdicts derived from them, are
   computed over a card's entire history with no date filter, so a 92 day
   extreme is being presented as a 52 week one on every MTG card page today.
   It is the same class of defect as C3L-15 but on a statistic nobody had
   checked, it is live now, and it was left unfixed only because correcting
   it moves verdicts across the whole catalogue and needs its own task with
   its own before-and-after. Alongside it, **C3L-36**: C3L-16's identical
