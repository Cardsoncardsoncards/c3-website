...
It's works for Pokemon and any other card game: the structure is game-agnostic. Whether you're tracking a Pokemon collection, an MTG collection, or a mix, the same tracker handles all of it.
