...
The most recent and currently recommended beginner option. The adventure takes place on an island and involves dragon-related content appropriate for new players. Key contents:

- 48-page rulebook (covers enough to play levels 1 to 3)
- Adventure book (designed for 10 to 20 hours of play across several sessions)
- Six pre-made character sheets covering a range of classes
...
An alternative starter set with a different adventure setting. Similar format: condensed rulebook, pre-written adventure, pre-made characters, dice. The adventure setting and tone differ from Stormwreck Isle, giving groups a different first-session experience.

**Who this suits:** Groups that want an alternative starting adventure, or groups where one person has played before and wants to DM a slightly different entry-level adventure.
...
An older starter set still available through Amazon AU. Contains the foundational adventure Lost Mine of Phandelver, which is widely regarded as one of the better introductory D&D adventures ever written. The rules are slightly older (pre-2024 revision) but fully playable and compatible with the current game.

**Who this suits:** Groups interested in Lost Mine of Phandelver specifically, or groups who find the older set at a lower price.
...
**Is a starter set worth it if someone in the group already plays D&D?**
...
**Are older D&D starter sets still compatible with the current rules?**
Broadly yes. D&D 5th edition rules are compatible across editions with minor differences. Starter sets using older rules work fine and the adventures are still playable. The 2024 core books introduced some revisions but the game is the same game.
