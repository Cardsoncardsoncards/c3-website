---
layout: post
title: "Riftbound Booster Box Value Australia: Open or Buy Singles?"
description: "Is opening a Riftbound booster box worth it in Australia? Confirmed box contents, AU pricing, pull rates, and when sealed beats singles."
date: 2026-05-30
...
Riftbound booster boxes contain 24 packs of 14 cards each. Confirmed AU pricing: Origins boxes were listed at approximately AU$389 RRP at Good Games Australia. Unleashed Booster Displays are priced at AU$299.99 at Vault Games Brisbane. Each box guarantees roughly two Alternate Art champion cards and approximately one Overnumbered card per three boxes. Whether opening beats buying singles depends entirely on which cards you want. Use the [EV Calculator at /tools](/tools) to run the numbers before committing.
...
Spiritforged Booster Box: check current AU retail pricing at your local store or [eBay AU here](https://rover.ebay.com/rover/1/705-53470-19255-0/1?campid=5339146789&toolid=10001&mpre=https%3A%2F%2Fwww.ebay.com.au%2Fsch%2Fi.html%3F_nkw%3DRiftbound+Spiritforged+booster+box+Australia). Note that Unleashed is cheaper than Origins at AU retail, which reflects supply differences between the current set and older stock.
...
Use the [Compare tool at /compare](/compare) to evaluate specific singles against each other before purchasing.

## The Maths Made Simple

Run your own numbers at the [EV Calculator at /tools](/tools), but the framework is this: add up the current AUD value of all singles you expect to pull from an average box (two Alternate Arts, proportional Epics and Rares, one-third of an Overnumbered). If that sum is below the box price, the box loses on expected value. It usually does. The question is by how much and whether the bulk cards have any value to you.

Find current Riftbound booster boxes on eBay AU: [search eBay for Riftbound booster box](https://rover.ebay.com/rover/1/705-53470-19255-0/1?campid=5339146789&toolid=10001&mpre=https%3A%2F%2Fwww.ebay.com.au%2Fsch%2Fi.html%3F_nkw%3DRiftbound+booster+box+Australia).
