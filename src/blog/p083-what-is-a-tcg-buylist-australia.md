...
- The store's margin requirements and sales volume
- Whether competing stores are also buying the card
...
- You have high-value singles (AU$30+) and you have time to sell them on eBay
- You need the full market value and aren't in a rush
- The store's buylist prices for your cards are zero (they don't want them)
...
A buylist is a published list of cards a game store is willing to purchase from the public, along with the price they'll pay for each card in cash and store credit. Sellers check the buylist, submit matching cards, and receive payment once the store assesses condition.

**Do Australian game stores buy all TCG cards?**
