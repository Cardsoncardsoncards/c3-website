...
**Why it works**: tribal synergy, mana advantage, enables explosive mid-game turns.
...
**Why it works**: multiple lines of play, can win fairly or go for combo, strong individual power level.
**Current AU price**: approximately AU$8 to AU$25 depending on printing.
...
**Why it works**: aggressive strategy, generates massive board presence, Human synergies are deep.
**Current AU price**: approximately AU$3 to AU$10.
...
**Why it works**: raw power, immediate board impact, weakens most creature-based strategies.
**Current AU price**: varies by printing from AU$15 to AU$60+. Check current price at [C3](/cards/mtg/elesh-norn-grand-cenobite).
...
Not sure which white Commander to build? Use the [C3 Random Commander Generator](/cards/mtg/random-commander) with the White (W) filter to get a random suggestion. You can filter by mana value to stay within your budget range.

## Finding Cards in Australia

Current eBay AU pricing for most of these cards is available on each [C3 card page](/cards/mtg). You can also search the [C3 eBay store](https://www.ebay.com.au/str/cardsoncardsoncards?mkcid=1&mkrid=705-53470-19255-0&campid=5339146789&customid=c3blog&toolid=10001&mkevt=1) for available stock.
