...
If this sounds intimidating, Structure Decks exist precisely for this reason — they're legal, pre-built, competitively functional decks designed to teach modern mechanics without needing to build from scratch.
...
2. **Standby Phase** — some card effects trigger here
3. **Main Phase 1** — summon monsters, play spells and traps
4. **Battle Phase** — attack with your monsters
5. **Main Phase 2** — more spells and traps, if needed
6. **End Phase** — discard to 6 if you have too many cards
