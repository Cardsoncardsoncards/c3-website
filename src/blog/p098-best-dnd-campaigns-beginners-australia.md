...
**D&D Starter Set (Lost Mine of Phandelver) on Amazon AU**
Includes the adventure, rulebook, dice, and pre-made characters.

[Shop D&D Starter Set on Amazon AU](https://www.amazon.com.au/s?k=dnd+starter+set+phandelver&tag=blasdigital-22){:target="_blank" rel="noopener noreferrer"}
...
**Do I need to buy a campaign book to start D&D?**
...
**Where can I buy D&D campaign books in Australia?**
EB Games and local game stores carry major D&D hardcovers. Amazon AU stocks the full range with Prime shipping. D&D Beyond sells digital versions that can be shared across a group.
