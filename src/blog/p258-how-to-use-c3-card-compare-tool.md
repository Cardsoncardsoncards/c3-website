...
The [C3 Card Compare tool](/compare) lets you put two cards side by side and see their current Australian prices, 14-day price trend, and buy versus sell spread. It covers MTG, Pokemon, Lorcana, One Piece, Yu-Gi-Oh, Dragon Ball Super, Star Wars Unlimited, and Riftbound.
...
- **MTG**: Full card database including alternate arts, foil prices, and Card Kingdom buylist integration
- **Pokemon**: All sets from the Scarlet and Violet era and earlier available
- **Lorcana**: All sets including Wilds Unknown
- **One Piece**: All English sets
- **Yu-Gi-Oh**: Current and recent sets
- **Dragon Ball Super**: Available sets
- **Star Wars Unlimited**: All released sets
- **Riftbound**: Origins, Spiritforged, and Unleashed
...
- **MTG buylist context**: The Card Kingdom buylist integration is not available from eBay search
...
**[C3 EV Calculator](/ev-calculator)**: For evaluating whether a booster box is worth opening based on current singles prices.

**[C3 Market](/market)**: 7-day price movement across all 8 TCGs on a single page. Use Market to find which cards are trending before using Compare for a detailed look.
