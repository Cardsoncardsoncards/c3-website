...
This is the question we will answer properly in our full [Wilds Unknown EV Calculator](https://cardsoncardsoncards.com.au/ev-calculator) once the Pokemon and Lorcana calculators are live. The short version:
...
Based on our four-box opening, the set has strong EV driven by Enchanted and Epic rarity cards. The first appearances of Pixar characters (The Incredibles, Toy Story, Brave) drove collector demand above typical set levels. Use the [C3 EV Calculator](/ev-calculator) at your current purchase price for a precise verdict.
