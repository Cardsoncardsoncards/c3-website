...
A shared family TCG collection is one of the most sustainable ways to engage with the hobby. Everyone contributes, everyone plays with the same cards, and the cost is distributed across the household rather than concentrated on one person's budget. See current prices at [C3 MTG card prices](/cards/mtg).
