...
Simic (blue-green) is considered one of the strongest two-colour combinations in Commander. Blue provides card draw and interaction; green provides ramp and large creatures. Combined, they produce the most efficient tempo strategies in the format. See current prices at [C3 MTG card prices](/cards/mtg).
