...
**Why it works**: self-generating card advantage, synergises with impulse draw, builds toward combo or beatdown.
...
Use the [C3 Random Commander Generator](/cards/mtg/random-commander) with B and R filters for Rakdos commanders. Check prices at [C3 Card Vault](/cards/mtg).
