...
- Remaining slots for land or landmark equivalents
...
For current AU pricing on Riftbound singles, use the [C3 Card Vault](https://cardsoncardsoncards.com.au/cards) and navigate to the Riftbound section.
