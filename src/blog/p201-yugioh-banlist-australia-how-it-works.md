...
In Magic: The Gathering, card prices spike or drop gradually based on tournament results and reprint announcements. In Yu-Gi-Oh, they can drop 60% to 80% overnight when the Forbidden and Limited List updates. See current prices at [C3 Yu-Gi-Oh card prices](/cards/yugioh).
