...
Five-colour Commanders are the most flexible in the format. With access to all five colours of Magic, these commanders can include the best cards in the entire game. The challenge is the mana base. playing five colours requires a significant investment in dual lands to cast spells reliably. See current prices at [C3 MTG card prices](/cards/mtg).
...
- **Kenrith, the Returned King**: versatile utility, AU$3 to AU$8
- **O-Kagachi, Vengeful Kami**: political deterrence, AU$2 to AU$5
- **Morophon, the Boundless**: tribal payoff, AU$8 to AU$15

## Mana Base Essentials for Five-Colour

- **Command Tower** (AU$1 to AU$3): mandatory
- **Arcane Signet** (AU$1 to AU$4): fast ramp
- **Sol Ring** (AU$2 to AU$5): mandatory
- **Chromatic Lantern** (AU$3 to AU$8): colour fixing
- Fetch lands and shock lands for higher-budget builds

Use the [C3 Random Commander Generator](/cards/mtg/random-commander) with no colour filter to see all five-colour commanders. Browse prices at [C3 Card Vault](/cards/mtg).
...
- **Fetch lands**: Flooded Strand, Polluted Delta, Bloodstained Mire, Wooded Foothills, Windswept Heath (AU$8 to AU$25 each)
- **Shocklands**: All 10 at AU$8 to AU$20 each
- **Triomes**: Savai Triome, Ketria Triome, etc. (AU$3 to AU$8 each)
- **Mana Confluence** (AU$8 to AU$15): taps for any colour at the cost of 1 life
