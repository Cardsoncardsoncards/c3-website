...
**Required:**
- Your deck, sleeved and legal
- Printed deck list (two copies, one for submission, one for your reference)
- Photo ID
- Dice, counters, life total tracker
...
- Snacks and lunch
- Light jacket (venues are cold from air conditioning)
- Extra sleeves in case one tears mid-round
- Cash for trading or small purchases

**Optional but useful:**
- A trade binder with cards you are willing to move
- Business cards if you want to connect with people for future testing
