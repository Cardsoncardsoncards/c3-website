...
- Always specify the set code and collector number in your title. Yu-Gi-Oh has multiple prints and rarities of many cards — buyers need to know exactly which version they're getting.
- Specify rarity clearly: Common, Rare, Super Rare, Ultra Rare, Secret Rare, Quarter Century Secret Rare, etc.
- List condition honestly using the standard NM/LP/MP/HP terminology. Yu-Gi-Oh players are particularly sensitive to condition grading.
- For valuable cards, photographs of the actual card are important. Foiling and wear is difficult to judge from stock images.
- Check eBay AU completed listings — not just current listings — to set realistic prices. What cards are actually selling for is more relevant than what sellers are asking.
...
- **Forbidden and Limited list updates:** A card that gets banned or Limited drops in value immediately. If you're holding cards that are popular meta cards, check the F&L list update schedule and consider selling before the next announcement if there's rumour or risk.
- **Reprint announcements:** Konami reprints cards frequently. When a card is confirmed for a reprint in an upcoming set, its price drops in anticipation. Selling before the reprint announcement hits is better than selling after.
- **New set releases:** New cards can make existing meta staples obsolete, dropping their demand and price. Sell cards that are powerful in the current meta before the next major set release if you're unsure whether they'll retain relevance.
...
- **eBay AU completed listings:** Filter to sold items to see actual sell prices
- **MTGGoldfish:** Covers Yu-Gi-Oh card prices in USD — useful as a reference point with exchange rate adjustment
- **YGOPrices.com:** Dedicated Yu-Gi-Oh price tracking
- **Cardmarket:** European prices, useful for trending data even if not directly applicable to AU
...
Current meta staples, Secret Rares and Quarter Century Rares from recent sets, 1st Edition copies of older sets, and cards in highly sought-after competitive archetypes. Check eBay AU completed listings for current prices — the market shifts quickly and estimates become outdated fast.

**Is eBay or Facebook better for selling Yu-Gi-Oh cards in Australia?**
...
Check eBay AU sold listings, not just current listings. Sold listings show actual transaction prices rather than aspirational asking prices. Filter by completed sales, note the price range over the last 30 days, and price competitively within that range.
