...
export default async (req) => {
  ...
  const [setsRes, cardsRes] = await Promise.allSettled([
    supabaseGet('wow_sets?order=release_date.desc&limit=100&select=id,name,slug,release_date,card_count'),
  ...
  function carouselCard(c, suffix) {
    ...
    const ebay  = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(c.name+' WoW TCG card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/wow" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">World of Warcraft TCG</a>
    ...
    <a href="https://www.ebay.com.au/sch/i.html?_nkw=world+of+warcraft+tcg+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=world+of+warcraft+tcg+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#1a1a2e,${ACCENT});color:#fff">&#128722; Shop World of Warcraft TCG on eBay &#8599;</a>
