...
export default async (req) => {
  ...
  const [setsRes, cardsRes, gainersRes, losersRes] = await Promise.allSettled([
    supabaseGet('vanguard_sets?order=release_date.desc&limit=400&select=id,name,slug,release_date,card_count'),
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/vanguard" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">Cardfight Vanguard</a>
    ...
    <a href="https://www.ebay.com.au/sch/i.html?_nkw=cardfight+vanguard+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=cardfight+vanguard+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#1a1a2e,${ACCENT});color:#fff">&#128722; Shop Cardfight Vanguard on eBay &#8599;</a>
