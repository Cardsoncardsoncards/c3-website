...
<head>
  ...
  ${hubSchemaHtml({ game: 'bakugan', label: "Bakugan", name: "Bakugan TCG Card Prices Australia", description: "Bakugan TCG card prices in AUD. Browse sets and buy on eBay AU." })}
