    ...
    for (const set of rotationOrder) {
      ...
      for (const card of setCards) {
        ...
        cardRows.push({
          ...
          // update_yugioh_price_changes() computes each night from C3's OWN price_aud snapshots
          ...
          // update_yugioh_price_changes() computes BOTH fields with the identical 1 day
          ...
          //   24h 28,266 to 38,525 (wider)
          //   30d 31,069 to 29,947 (NARROWER by 1,122, accepted for the same reason)
