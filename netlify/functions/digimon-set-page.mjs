...
export default async (req) => {
  ...
  const setSlug = url.pathname.replace(/^\/cards\/digimon\/sets\//, '').replace(/\/$/, '');
...
<div class="wrap">
  ...
  <div style="background:#0e1118;border:1px solid #1e2235;border-radius:10px;padding:20px;font-size:13px;color:#8892b0">
    <strong style="color:#F0F2FF">About this set:</strong> Digimon TCG card prices in AUD, converted from USD at approximately 1.45x. Updated daily.
