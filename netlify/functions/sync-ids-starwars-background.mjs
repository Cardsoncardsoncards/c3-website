// netlify/functions/sync-ids-starwars-background.mjs
// Resolves tcgplayer_id -> tcgapi.dev internal ID for starwars cards only.
...
const GAME_CONFIG = { game: 'starwars', table: 'starwars_cards', priceCol: 'market_price' };
...
async function selfChain() {
  try {
    fetch(`${SITE_URL}/.netlify/functions/sync-ids-starwars-background`, {
      method: 'POST',
