...
// Group B sync (Tue/Thu/Sat) - schedule: 30 22 * * 2,4,6 UTC
...
export default async (req) => {
  console.log('[sync-buddyfight] Starting (background function)...');
    ...
    for (const set of allSets) {
      ...
      for (let i = 0; i < cardIds.length; i += 500) {
        ...
        try {
          ...
          console.error(`[sync-buddyfight] Bulk price error set ${set.id}:`, e.message);
        }
      }
