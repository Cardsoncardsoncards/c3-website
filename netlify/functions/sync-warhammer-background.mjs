...
// Group A sync (Mon/Wed/Fri/Sun) - schedule: 30 0 * * 1,3,5,0 UTC
// Fetches all warhammer-age-of-sigmar-champions-tcg sets + cards + prices from tcgapi.dev Pro
...
const GAME_SLUG            = 'warhammer-age-of-sigmar-champions-tcg';
...
export default async (req) => {
  console.log('[sync-warhammer] Starting (background function)...');
    ...
    for (const set of allSets) {
      ...
      for (let i = 0; i < cardIds.length; i += 500) {
        ...
        try {
          ...
          console.error(`[sync-warhammer] Bulk price error set ${set.id}:`, e.message);
        }
      }
