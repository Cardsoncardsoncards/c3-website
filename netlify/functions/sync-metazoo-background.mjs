...
// Group A sync (Mon/Wed/Fri/Sun) - schedule: 15 23 * * 0,1,3,5 UTC
...
export default async (req) => {
  console.log('[sync-metazoo] Starting (background function)...');
    ...
    for (const set of allSets) {
      ...
      for (let i = 0; i < cardIds.length; i += 500) {
        ...
        try {
          ...
          console.error(`[sync-metazoo] Bulk price error set ${set.id}:`, e.message);
        }
      }
