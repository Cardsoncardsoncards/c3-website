...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/lorcana" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">Lorcana</a>
    ...
    <a href="https://www.ebay.com.au/str/cardsoncardsoncards?mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&customid=C3Nav&toolid=10001&mkevt=1" target="_blank" rel="noopener" onclick="gtag('event','ebay_click',{'event_category':'affiliate','event_label':'lorcana-hub'})" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
