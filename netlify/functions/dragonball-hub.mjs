...
export default async (req) => {
  ...
  const setListHTML = sets.length ? sets.map(s => `
    <a href="/cards/dragonball/sets/${encodeURIComponent(s.abbreviation||s.slug||s.id)}" class="set-tile" data-name="${(s.name||'').toLowerCase()}">
...
<head>
  ...
  <title>Dragon Ball Super Card Game Prices Australia | Cards on Cards on Cards</title>
  <meta name="description" content="Browse Dragon Ball Super Card Game prices in AUD. Live pricing and eBay AU buy links for DBS cards. Australia's Dragon Ball TCG price guide updated daily.">
  <link rel="canonical" href="https://cardsoncardsoncards.com.au/cards/dragonball">
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-WR68HPE92S"></script>
  <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-WR68HPE92S');</script>
  ${NAV_STYLES}
  <style>
    :root{--bg:#0A0C14;--bg2:#111420;--bg3:#181d2e;--gold:#C9A84C;--gold-dim:rgba(201,168,76,.3);--db-orange:#F97316;--text:#F0F2FF;--text2:#A0A8C0;--border:#252840;}
    *{box-sizing:border-box;margin:0;padding:0}
    body{background:var(--bg);color:var(--text);font-family:'DM Sans',sans-serif;line-height:1.6;overflow-x:hidden}
    body::before{content:'';position:fixed;inset:0;pointer-events:none;background:radial-gradient(ellipse 80% 40% at 50% -10%,rgba(249,115,22,.07),transparent 60%);z-index:0}
    ...
    .hero-eyebrow{font-size:10px;font-weight:700;letter-spacing:.35em;text-transform:uppercase;color:var(--db-orange);margin-bottom:12px}
    ...
    .stat-num{font-family:'Cinzel',serif;font-size:20px;font-weight:700;color:var(--db-orange)}
    .stat-label{font-size:11px;color:var(--text2);text-transform:uppercase;letter-spacing:.08em;margin-top:2px}
    .gold-divider{width:100%;height:1px;background:linear-gradient(90deg,transparent,rgba(249,115,22,.3),var(--db-orange),rgba(249,115,22,.3),transparent);margin:40px 0}
    ...
    .carousel-card:hover{border-color:var(--db-orange);transform:translateY(-2px)}
    ...
    .carousel-price{font-family:'Cinzel',serif;font-size:13px;font-weight:700;color:var(--db-orange)}
    ...
    .set-search:focus{outline:none;border-color:var(--db-orange)}
    ...
    .set-tile:hover{border-color:var(--db-orange)}
...
<div class="hero">
  ...
  <div class="stat-bar">
    ...
    <div class="stat-item"><div class="stat-num">6,261</div><div class="stat-label">Cards</div></div>
...
<div class="quick-links">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=dragon+ball+super+card+game&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#F97316,#C2410C);color:#fff">🛒 Shop Dragon Ball on eBay ↗</a>
  <a href="/quizzes/dragonball-character" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">🎯 Which DBS Character Are You?</a>
  <a href="/tracker.html" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">📋 Free Tracker</a>
  <a href="/blog/dragon-ball-super-card-game-australia-guide/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">📖 Beginners Guide →</a>
</div>
...
<div style="position:relative;z-index:1;margin-bottom:48px">
  ...
  <h2 class="section-title">Most Valuable Dragon Ball Cards</h2>
...
<footer>
  <p><a href="/">Home</a><a href="/shop.html">Shop</a><a href="/blog">Blog</a><a href="/ev-calculator.html">EV Calc</a><a href="/tracker.html">Tracker</a><a href="/cards/dragonball">Dragon Ball</a></p>
