...
export default async (req) => {
  ...
  const [setsRes, cardsRes, gainersRes, losersRes] = await Promise.allSettled([
    supabaseGet('dragonball_sets?order=release_date.desc&limit=300&select=id,name,slug,release_date,card_count'),
  ...
  function carouselCard(c, suffix) {
    ...
    const ebay  = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(c.name+' dragon ball super card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/dragonball" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">Dragon Ball</a>
    ...
    <a href="https://www.ebay.com.au/str/cardsoncardsoncards?mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&customid=C3Nav&toolid=10001&mkevt=1" target="_blank" rel="noopener" onclick="gtag('event','ebay_click',{'event_category':'affiliate','event_label':'dragonball-hub'})" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=dragon+ball+super+cards&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" onclick="gtag('event','ebay_click',{'event_category':'affiliate','event_label':'dragonball-hub'})" class="quick-link" style="background:linear-gradient(135deg,#92400e,${ACCENT});color:#000">&#128722; Shop Dragon Ball Super on eBay &#8599;</a>
...
<footer>
  ...
  <p style="margin-top:6px;font-size:11px;opacity:.5">Affiliate disclosure: this site earns commissions from eBay AU and Amazon AU purchases made through affiliate links at no extra cost to you. Not affiliated with Bandai. USD prices converted to AUD at approximately 1.58.</p>
</footer>
