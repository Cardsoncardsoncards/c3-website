...
function graceful404(slug) {
  ...
  const ebayUrl = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(cardName+' union arena card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
  return `<!DOCTYPE html>
<html lang="en-AU">
<head>
...
export default async (req) => {
  ...
  const ebayCardUrl  = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent((card.name||slug.replace(/-/g,' '))+' union arena card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
  ...
  <div class="card-layout">
    ...
    <div class="card-info">
      ...
      <div class="price-block">
        ...
        ${followBlockHtml({ game: 'unionarena', slug: slug, cardName: card.name, printingId: card.tcgplayer_id })}
      </div>
...
${viewTrackingScript('unionarena', slug)}
</body>
</html>`;
