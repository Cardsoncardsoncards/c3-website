...
const GAME_LABEL  = 'Yu-Gi-Oh';
const ACCENT      = '#c8a332';
const ACCENT_RGB  = '200,163,50';
const EMOJI       = '&#128065;';
const SEARCH_PH   = 'Blue-Eyes, Dark Magician, Ash Blossom...';
const SET_PH      = 'Rarity Collection, Phantom Nightmare...';
...
export default async (req) => {
  ...
  const [setsResult, topCardsResult] = await Promise.allSettled([
    supabaseGet('yugioh_sets?order=release_date.desc&limit=700&select=id,name,slug,abbreviation,release_date,card_count'),
  ...
  const carouselHTML = topCards.map(c => {
    ...
    const ebaySearch = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(c.name + ' yugioh card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
  ...
  const setListHTML = sets.length
    ? sets.map(s => {
        ...
        return `<a href="/cards/yugioh/sets/${setId}" class="set-tile" data-name="${esc(name.toLowerCase())}" data-letter="${letterKey}">
...
<head>
  ...
  <meta name="description" content="Browse 600+ Yu-Gi-Oh sets. Live AUD card prices, eBay AU buy links. Australia's Yu-Gi-Oh price guide updated daily.">
  <link rel="canonical" href="${CANONICAL}">
  <link rel="icon" type="image/png" href="/c3logo.png">
  <meta property="og:title" content="Yu-Gi-Oh Card Prices Australia | Cards on Cards on Cards">
  <meta property="og:description" content="600+ sets, 46k+ cards. Live AUD prices and eBay AU buy links updated daily.">
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="/cards/yugioh" class="nav-link" style="color:#9333EA;border-color:#9333EA80;background:#9333EA14">Yu-Gi-Oh</a>
...
<div class="hero fade-up">
  ...
  <h1>Yu-Gi-Oh Card Prices</h1>
  <p class="hero-sub">Yu-Gi-Oh card prices in AUD. Browse every set with live eBay AU buy links. Updated daily.</p>
  <div class="stat-bar">
    <div class="stat-item"><div class="stat-num">${sets.length || '611'}</div><div class="stat-label">Sets</div></div>
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=yugioh+cards&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=5339146789&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#7a6020,#c8a332);color:#000">&#128722; Shop Yu-Gi-Oh on eBay &#8599;</a>
  ...
  <a href="/blog/yugioh-tcg-beginners-guide-australia/" class="quick-link" style="background:rgba(var(--accent-rgb),.08);border-color:rgba(200,163,50,.3);color:var(--accent)">&#128214; Beginners Guide &#8594;</a>
  <a href="/blog/how-to-sell-yugioh-cards-australia/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128200; How to Sell YGO Cards &#8594;</a>
</div>
...
<div class="wrap">
  ...
  <div class="section fade-up fade-up-3">
    <div class="section-header">
      <div class="section-title">Browse ${sets.length || '611'} Sets</div>
