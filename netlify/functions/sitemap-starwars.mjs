// netlify/functions/sitemap-starwars.mjs
// Generates XML sitemap for One Piece card pages at /cards/starwars/[slug]
// Registered in sitemap-index.xml as /api/sitemap-starwars
// Returns valid empty sitemap until starwars_cards table is created and synced
...
${urls}
    ...
    console.error('[sitemap-starwars] error:', err.message);
    return new Response(
...
export const config = { path: '/api/sitemap-starwars' };
