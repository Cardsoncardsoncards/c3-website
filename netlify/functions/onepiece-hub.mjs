...
<head>
  ...
  ${hubSchemaHtml({ game: 'onepiece', label: "One Piece", name: "One Piece Card Prices Australia", description: `Browse ${sets.length||'75'}+ One Piece TCG sets. Live AUD card prices, eBay AU buy links. Australia's One Piece TCG price guide, updated daily.` })}
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    @media(max-width:600px){.hero{padding:36px 16px 24px}.quick-links{padding:0 12px}.wrap{padding:0 12px}
