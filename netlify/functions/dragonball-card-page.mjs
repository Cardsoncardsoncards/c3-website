...
async function handleSetPage(setSlug, headers) {
  ...
  const notFound = `<!DOCTYPE html><html lang="en-AU"><head><meta charset="UTF-8"><title>Set Not Found | Dragon Ball Super | Cards on Cards on Cards</title><meta name="robots" content="noindex"><link rel="icon" type="image/png" href="/c3logo.png"></head><body style="background:#0A0C14;color:#F0F2FF;font-family:sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;flex-direction:column;gap:16px;padding:24px;text-align:center"><h1 style="font-family:'Cinzel',serif;color:${ACCENT}">Set Not Found</h1><p style="color:#A0A8C0">We couldn't find Dragon Ball Super set "${setSlug}".</p><a href="/cards/dragonball" style="color:${ACCENT}">← Browse All Dragon Ball Super</a></body></html>`;
  ...
  const top5HTML = top5.map(c => {
    const aud = toAud(c);
    return `<a href="/cards/dragonball/${c.slug}" style="flex:0 0 140px;background:#0e1118;border:1px solid rgba(249,115,22,.35);border-radius:10px;padding:10px;text-align:center;text-decoration:none;display:block">
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="/cards/dragonball" class="nav-link" style="color:${ACCENT};border-color:rgba(249,115,22,.4)">Dragon Ball Super</a>
...
<div class="wrap">
  ...
  <div style="background:#0e1118;border:1px solid #1e2235;border-radius:10px;padding:20px;font-size:13px;color:#8892b0">
    <strong style="color:#F0F2FF">About this set:</strong> Dragon Ball Super card prices in AUD. Updated daily via tcgapi.dev.
...
<footer style="border-top:1px solid #252840;padding:24px;text-align:center;color:#8892b0;font-size:12px;margin-top:20px">
  <p><a href="/" style="color:#8892b0;margin:0 8px">Home</a><a href="/cards/dragonball" style="color:#8892b0;margin:0 8px">Dragon Ball Super</a><a href="/blog" style="color:#8892b0;margin:0 8px">Blog</a></p>
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      <a href="/" class="nav-link">Home</a>
      <a href="/cards/dragonball" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}40">Dragon Ball Super</a>
      <a href="/shop.html" class="nav-link">Shop</a>
      <a href="/compare" class="nav-link">Compare</a>
      <a href="/tracker.html" class="nav-link">Tracker</a>
    </div>
...
<div class="wrap">
  ...
  <div class="card-layout">
    ...
    <div>
      ...
      <div class="cta-bar">
        <a href="${ebayBuyURL}" target="_blank" rel="noopener" class="cta-btn" style="background:linear-gradient(135deg,${ACCENT},${ACCENT}aa);color:#0A0C14">🛒 Buy on eBay AU ↗</a>
        <a href="https://www.amazon.com.au/s?k=${encodeURIComponent(card.name+' dragon ball super')}&tag=${AMAZON_TAG}" target="_blank" rel="noopener" class="cta-btn" style="background:rgba(255,153,0,.1);border:1px solid rgba(255,153,0,.35);color:#ff9900">Search Amazon AU →</a>
...
<footer>
  <p><a href="/">Home</a><a href="/cards/dragonball">Dragon Ball Super</a><a href="/shop.html">Shop</a><a href="/blog">Blog</a><a href="/tracker.html">Tracker</a></p>
  <p style="margin-top:8px">© 2026 Cards on Cards on Cards · cardsoncardsoncards.com.au</p>
