...
export default async (req) => {
  ...
  const [setsRes, cardsRes, gainersRes, losersRes] = await Promise.allSettled([
    supabaseGet('riftbound_sets?order=release_date.desc&limit=300&select=id,name,slug,release_date,card_count'),
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/riftbound" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">Riftbound</a>
    ...
    <a href="https://www.ebay.com.au/str/cardsoncardsoncards?mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&customid=C3Nav&toolid=10001&mkevt=1" target="_blank" rel="noopener" onclick="gtag('event','ebay_click',{'event_category':'affiliate','event_label':'riftbound-hub'})" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
...
<div class="quick-links fade-up fade-up-1">
  ...
  <a href="/blog/best-riftbound-booster-boxes-australia/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128230; Best Boxes &#8594;</a>
  <a href="/blog/is-riftbound-worth-it-australia/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128214; Is It Worth It? &#8594;</a>
...
<footer>
  ...
  <p style="margin-top:6px;font-size:11px;opacity:.5">Affiliate disclosure: this site earns commissions from eBay AU and Amazon AU purchases made through affiliate links at no extra cost to you. Not affiliated with Riot Games. USD prices converted to AUD at approximately 1.58.</p>
</footer>
