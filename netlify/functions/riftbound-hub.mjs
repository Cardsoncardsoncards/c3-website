...
export default async (req) => {
  ...
  const setListHTML = sets.length ? sets.map(s => `
    <a href="/cards/riftbound/sets/${encodeURIComponent(s.abbreviation||s.slug||s.id)}" class="set-tile" data-name="${(s.name||'').toLowerCase()}">
...
<head>
  ...
  <title>Riftbound Card Prices Australia | Cards on Cards on Cards</title>
  <meta name="description" content="Browse Riftbound card prices in AUD. Live AUD pricing and eBay AU buy links. Australia's Riftbound price guide updated daily.">
  <link rel="canonical" href="https://cardsoncardsoncards.com.au/cards/riftbound">
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-WR68HPE92S"></script>
  <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-WR68HPE92S');</script>
  ${NAV_STYLES}
  <style>
    :root{--bg:#0A0C14;--bg2:#111420;--bg3:#181d2e;--gold:#C9A84C;--gold-dim:rgba(201,168,76,.3);--op-gold:#C9A84C;--text:#F0F2FF;--text2:#A0A8C0;--border:#252840;}
    *{box-sizing:border-box;margin:0;padding:0}
    body{background:var(--bg);color:var(--text);font-family:'DM Sans',sans-serif;line-height:1.6;overflow-x:hidden}
    body::before{content:'';position:fixed;inset:0;pointer-events:none;background:radial-gradient(ellipse 80% 40% at 50% -10%,rgba(201,168,76,.07),transparent 60%);z-index:0}
    ...
    .hero-eyebrow{font-size:10px;font-weight:700;letter-spacing:.35em;text-transform:uppercase;color:var(--op-gold);margin-bottom:12px}
    ...
    .stat-num{font-family:'Cinzel',serif;font-size:20px;font-weight:700;color:var(--op-gold)}
    ...
    .carousel-card:hover{border-color:var(--op-gold);transform:translateY(-2px)}
    ...
    .carousel-price{font-family:'Cinzel',serif;font-size:13px;font-weight:700;color:var(--op-gold)}
    ...
    .set-search:focus{outline:none;border-color:var(--op-gold)}
    ...
    .set-tile:hover{border-color:var(--op-gold)}
...
<div class="hero">
  ...
  <p class="hero-sub">Riftbound card prices in AUD. Browse by set or character. eBay AU buy links updated daily.</p>
  <div class="stat-bar">
...
<div class="quick-links">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=riftbound+card+game&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#C9A84C,#9A7B28);color:#fff">🛒 Shop Riftbound on eBay ↗</a>
  <a href="/tracker.html" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">📋 Free Tracker</a>
  <a href="/blog/riftbound-card-game-australia-beginners-guide/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">📖 Beginners Guide →</a>
</div>
...
<div style="position:relative;z-index:1;margin-bottom:48px">
  ...
  <h2 class="section-title">Most Valuable Riftbound Cards</h2>
...
<footer>
  <p><a href="/">Home</a><a href="/shop.html">Shop</a><a href="/blog">Blog</a><a href="/ev-calculator.html">EV Calc</a><a href="/tracker.html">Tracker</a><a href="/cards/riftbound">Riftbound</a></p>
