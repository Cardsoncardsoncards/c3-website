...
<head>
  ...
  <meta name="description" content="Browse ${sets.length||'10'}+ Star Wars: Unlimited sets. Live AUD card prices, eBay AU buy links. Australia's most complete Star Wars price guide, updated daily.">
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=star+wars+unlimited+cards&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#1a1a1a,${ACCENT});color:#000">&#128722; Shop Star Wars Unlimited on eBay &#8599;</a>
...
${topCards.length ? `<section class="carousel-section fade-up fade-up-2">
  ...
  <div class="carousel-title">Top Star Wars Cards by Price (AUD)</div>
...
${hasMovers ? `<div style="margin-bottom:28px">
  ...
  <div style="margin-bottom:28px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px">
      ...
      <a href="/ev-calculator.html" class="guide-card"><div class="guide-title">Booster Box EV Calculator</div><div class="guide-desc">Is your Star Wars box worth opening? Calculate expected value before you crack it.</div></a>
