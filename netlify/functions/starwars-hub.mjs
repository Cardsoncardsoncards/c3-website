...
const EMOJI       = '&#11088;';
const SEARCH_PH   = 'Luke Skywalker, Darth Vader, Han Solo...';
const SET_PH      = 'Spark of Rebellion, Shadows of the Galaxy...';
const CANONICAL   = 'https://cardsoncardsoncards.com.au/cards/starwars';

const CALENDAR_EVENTS = [
  { date: '2026-07-01', name: 'Star Wars Unlimited Set 5', type: 'Set Release' },
];
...
export default async (req) => {
  ...
  const [setsResult, topCardsResult] = await Promise.allSettled([
    supabaseGet('starwars_sets?order=release_date.desc&limit=100&select=id,name,slug,abbreviation,release_date,card_count'),
    supabaseGet('starwars_cards?order=market_price.desc&market_price=gt.0&image_url=not.is.null&limit=24&select=slug,name,image_url,market_price,price_aud,rarity,set_name,updated_at')
  ]);
  ...
  const carouselHTML = topCards.map(c => {
    ...
    const ebaySearch = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(c.name + ' star wars unlimited card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
    return `<a href="/cards/starwars/${c.slug}" class="carousel-card">
  ...
  const setListHTML = sets.length
    ? sets.map(s => {
        ...
        return `<a href="/cards/starwars/sets/${setId}" class="set-tile" data-name="${esc(name.toLowerCase())}" data-letter="${letterKey}">
...
<head>
  ...
  <meta name="description" content="Browse Star Wars: Unlimited sets. Live AUD card prices, eBay AU buy links. Australia's Star Wars TCG price guide updated daily.">
  <link rel="canonical" href="${CANONICAL}">
  <link rel="icon" type="image/png" href="/c3logo.png">
  <meta property="og:title" content="Star Wars Unlimited Card Prices Australia | Cards on Cards on Cards">
  <meta property="og:description" content="Star Wars: Unlimited card prices in AUD with live eBay AU buy links, updated daily.">
...
<div class="hero fade-up">
  ...
  <p class="hero-sub">Star Wars: Unlimited card prices in AUD. Browse by set, find the most valuable cards, and buy on eBay AU.</p>
  <div class="stat-bar">
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=star+wars+unlimited+tcg+cards&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=5339146789&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:linear-gradient(135deg,#78350f,#FFE81F);color:#000">&#128722; Shop Star Wars on eBay &#8599;</a>
  ...
  <a href="/blog/star-wars-unlimited-booster-boxes-australia/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128230; Best SW Boxes &#8594;</a>
  <a href="/blog/star-wars-unlimited-beginners-guide-australia/" class="quick-link" style="background:rgba(var(--accent-rgb),.08);border-color:rgba(255,232,31,.3);color:var(--accent)">&#128214; Beginners Guide &#8594;</a>
  <a href="/blog/star-wars-unlimited-australia-guide/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128200; Australia Guide &#8594;</a>
</div>
...
<div class="wrap">
  <div class="section fade-up fade-up-2">
    <div class="section-header">
      <div class="section-title">Search Star Wars: Unlimited Cards</div>
    </div>
  ...
  <div class="section fade-up fade-up-3">
    <div class="section-header">
      <div class="section-title">Browse ${sets.length || '10+'} Sets</div>
...
<footer>
  ...
  <p style="margin-top:6px;font-size:11px;opacity:.5">Affiliate disclosure: this site earns commissions from eBay AU and Amazon AU purchases made through affiliate links at no extra cost to you. Not affiliated with Disney, Lucasfilm, or Fantasy Flight Games. USD prices converted to AUD at approximately 1.58.</p>
</footer>
