...
const EMOJI       = '&#9824;';
const SEARCH_PH   = "Hololive, Sword Art Online, Demon Slayer...";
const SET_PH      = "Hololive, SAO, Kaguya-sama...";
const CANONICAL   = 'https://cardsoncardsoncards.com.au/cards/weissschwarz';
...
export default async (req) => {
  ...
  const carouselHTML = topCards.map(c => {
    ...
    return `<a href="/cards/weissschwarz/${c.slug}" class="carousel-card">
  ...
  const setListHTML = sets.length ? sets.map(s => {
    ...
    return `<a href="/cards/weissschwarz/sets/${encodeURIComponent(s.slug||s.id)}" class="set-tile" data-name="${esc(name.toLowerCase())}" data-letter="${letterKey}">
...
<head>
  ...
  <meta name="description" content="Browse ${sets.length||'170'}+ Weiss Schwarz sets. Live AUD card prices and eBay AU buy links updated daily. Australia's Weiss Schwarz price guide.">
  <link rel="canonical" href="${CANONICAL}">
  <link rel="icon" type="image/png" href="/c3logo.png">
  <meta property="og:title" content="Weiss Schwarz Card Prices Australia | Cards on Cards on Cards">
  <meta property="og:description" content="${sets.length||'170'}+ Weiss Schwarz sets with live AUD prices and eBay AU buy links.">
...
<div class="hero fade-up">
  <div class="hero-eyebrow">Card Vault -- Weiss Schwarz</div>
  <h1>Weiss Schwarz Card Prices <span>in Australia</span></h1>
  <p class="hero-sub">Weiss Schwarz card prices in AUD. Browse by set or search by card name. eBay AU buy links updated daily.</p>
  <div class="stat-bar">
    <div class="stat-item"><div class="stat-num">${sets.length||'170'}</div><div class="stat-label">Sets</div></div>
    <div class="stat-item"><div class="stat-num">30k+</div><div class="stat-label">Cards</div></div>
...
<div class="quick-links fade-up fade-up-1">
  <a href="https://www.ebay.com.au/sch/i.html?_nkw=weiss+schwarz+cards&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=5339146789&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="quick-link" style="background:var(--accent);color:#000">&#128722; Shop Weiss Schwarz on eBay &#8599;</a>
  ...
  <a href="/blog/weiss-schwarz-beginners-guide-australia/" class="quick-link" style="background:rgba(var(--accent-rgb),.08);border-color:rgba(var(--accent-rgb),.3);color:var(--accent)">&#128214; Beginners Guide &#8594;</a>
  <a href="/blog/best-weiss-schwarz-sets-australia/" class="quick-link" style="background:var(--bg2);border-color:var(--border);color:var(--text)">&#128230; Best WS Sets &#8594;</a>
</div>

${topCards.length ? `<section class="carousel-section fade-up fade-up-2">
  <div class="carousel-label">Most Valuable</div>
  <div class="carousel-title">Top Weiss Schwarz Cards by Price (AUD)</div>
...
<div class="wrap">
  <div class="section fade-up fade-up-2">
    <div class="section-header"><div class="section-title">Search Weiss Schwarz Cards</div></div>
  ...
  <div class="section fade-up fade-up-3">
    <div class="section-header">
      <div class="section-title">Browse ${sets.length||'170'} Sets</div>
...
async function searchCard() {
  ...
  try {
    const res = await fetch('/api/compare-search?q=' + encodeURIComponent(q) + '&game=weissschwarz&limit=24');
    ...
    results.innerHTML = cards.map(c => {
      ...
      return '<a href="/cards/weissschwarz/'+c.slug+'" style="background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:8px;text-align:center;display:block;text-decoration:none;transition:border-color .2s" onmouseover="this.style.borderColor=\'var(--accent)\'" onmouseout="this.style.borderColor=\'var(--border)\'">'
...
export const config = { path: '/cards/weissschwarz' };
