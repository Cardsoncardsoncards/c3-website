...
export default async (req) => {
  ...
  const [setsRes, cardsRes] = await Promise.allSettled([
    supabaseGet('dragonballz_sets?order=release_date.desc&limit=100&select=id,name,slug,release_date,card_count'),
  ...
  function carouselCard(c, suffix) {
    ...
    const ebay  = `https://www.ebay.com.au/sch/i.html?_nkw=${encodeURIComponent(c.name+' Dragon Ball Z TCG card')}&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1`;
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/dragonballz" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">Dragon Ball Z TCG</a>
    ...
    <a href="https://www.ebay.com.au/sch/i.html?_nkw=dragon+ball+z+tcg+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
