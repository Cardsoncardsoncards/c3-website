...
export default async (req) => {
  ...
  const [setsRes, cardsRes, gainersRes, losersRes] = await Promise.allSettled([
    supabaseGet('metazoo_sets?order=release_date.desc&limit=50&select=id,name,slug,release_date,card_count'),
...
<nav><div class="nav-inner">
  ...
  <div class="nav-links">
    ...
    <a href="/cards/metazoo" class="nav-link" style="color:${ACCENT};border-color:${ACCENT}80;background:${ACCENT}14">MetaZoo</a>
    ...
    <a href="https://www.ebay.com.au/sch/i.html?_nkw=metazoo+tcg+card&_sacat=183454&mkcid=1&mkrid=705-53470-19255-0&siteid=15&campid=${EPN_CAMPID}&toolid=10001&mkevt=1" target="_blank" rel="noopener" class="nav-link nav-link--ebay">Shop eBay &#8599;</a>
  </div>
</div></nav>
