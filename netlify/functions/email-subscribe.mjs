// netlify/functions/email-subscribe.mjs
// Serves /api/email-subscribe -- adds an email to MailerLite group 182892277158381312
// Public POST endpoint, called from homepage email capture form.
...
export const config = { path: '/api/email-subscribe' };
