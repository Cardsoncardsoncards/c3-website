    ...
    for (const set of allSets) {
      ...
      for (const card of setCards) {
        ...
        cardRows.push({
          ...
          // update_starwars_price_changes() computes BOTH fields with the identical 1 day
          ...
          //   24h 7,201 to 7,476 (wider)
          //   30d 7,610 to 7,341 (NARROWER by 269, accepted for the same reason)
